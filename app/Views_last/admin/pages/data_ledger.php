                ...
                <table style="width: 150%;" id="tbDataLadger" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataLadger_info">
                  <thead class="bg-gray-dark">
                    <tr role="row">
                      ...
                      <th rowspan="3" colspan="2" class="text-center" width="5%" style="background-color: #00917C;">Total</th>
                      <th rowspan="3" colspan="2" class="text-center" width="5%" style="background-color: #00917C;">Average</th>
                      <th rowspan="3" colspan="2" class="text-center" width="5%" style="background-color: #025955;">Grade</th>
                    </tr>
                    <tr role="row">
                  ...
                  <tbody>
                    ...
                    <?php $tp = 0; $tk = 0; $no=1; foreach($list_pesdik->getResultArray() AS $lp): ?>
                      <tr>
                        ...
                        <td style="text-align:center; background-color: #EAFFD0; color:<?= ($n['p'] < $kkm->standard) ? '#B61919;' : '#000;'; ?>"><strong><?= ($n['k'] == '') ? '0' : $n['k'];?></strong></td>
                        <?php $tp += $n['p']; $tk += $n['k'];?>
                        <?php endforeach; ?>
                        <td style="text-align:right; background-color: #A4EBF3;"><strong><?=$tp; $ap=($tp/$list_mapel->getNumRows()); $tp=0;?></strong></td>
                        <td style="text-align:right; background-color: #CCF2F4;"><strong><?=$tk; $ak=($tk/$list_mapel->getNumRows()); $tk=0;?></strong></td>
                        <td style="text-align:right; background-color: #A4EBF3;"><strong><?= number_format($ap,2);?></strong></td>
                        <td style="text-align:right; background-color: #CCF2F4;"><strong><?= number_format($ak,2);?></strong></td>
                        <td style="text-align:right; background-color: #A4EBF3;"><strong><?= number_format($ak,2);?></strong></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
