              ...
              <div id="tbDataNilaiEskul_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                <table width="150%" id="tbDataNilaiEskul" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataNilaiEskul_info">
                  <thead class="bg-gray-dark">
                    <tr role="row">
                      <th width="10" rowspan="2"><div class='custom-control custom-checkbox'><input class='custom-control-input' type='checkbox' id='check-all' value='"+ value.id_nilai_Eskul+"'><label for='check-all' class='custom-control-label'>No</label></div></th>
                      <!-- <th width="20%">Nama Eskul</th> -->
                      <!-- <th width="9%" rowspan="2">NISN</th> -->
                      <th rowspan="2">Nama</th>
                      <th colspan="8" class="text-center" width="76%">Eskul</th>
                      <th width="4%" rowspan="2">Action</th>
                    </tr>
                    <tr role="row">
                      <th class="text-center" colspan="2">Eskul 1</th>
                      <th class="text-center" colspan="2">Eskul 2</th>
                      <th class="text-center" colspan="2">Eskul 3</th>
                      <th class="text-center" colspan="2">Eskul 4</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
