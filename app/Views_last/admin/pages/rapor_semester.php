...
<head>
    ...
    <style>
        ...
        body{width: 95%; margin: auto; left: 50%; right: 50%;}
...
<?php   
    ...
    <?php
        ...
        $absensi = $absensi->getAbsensiByNisn($pesdik->nisn,$_GET['ta']);
    ?>
    ...
    ?>
        ...
        <div  class="row score mt-4">
            <div class="col-5 mb-3"><h5>B. Keterampilan</h5></div>
            <div class="col-2 mb-3"></div>
            <div class="col-5 mb-3 text-right"><h5>KKM : <?= $kkm->standard; ?></h5></div>
            <div class="col-12">
                <table style="border: 1px; width:100%;">
                    ...
                    <tbody>
                        ...
                        <?php foreach($kelB->getResultArray() AS $m): ?>
                        <?php $n = $nilai->getDataNilaiByMapel($m['kd_mapel'],$pesdik->nisn,$_GET['ta']); ?> 
                        <?php $g = $grade->getGradeByScore($n->keterampilan); ?>
                        <?php $d = $desk->getDeskripsiByMapel($m['kd_mapel'])?>
                        <?php 
                            if(empty($n->na)){$na = 0;}else{$na = $n->na;}
                            switch ($g->grade) {
                        ...
                        <tr>
                            <td class="text-center"><?= $no++;?></td>
                            <td><?= $m['nm_mapel']."<br><i>".$m['nm_mapel_ing'];"</i>"?></td>
                            <td class="text-center"><?= $n->keterampilan ?></td>
                            <td class="text-center"><?=$g->grade;?></td>
                            <td><?=$desc;?></td>
    ...
    <div class="paper">
        ...
        <div  class="row score mt-4">
            ...
            <div class="col-12 text-left">
               <table width="50%">
                   <tr><td width="50%">Sakit</td><td align="center"><?=$absensi->sakit?></td></tr>
                   <tr><td>Izin</td><td align="center"><?=$absensi->izin?></td></tr>
                   <tr><td>Tanpa Keterangan</td><td align="center"><?=$absensi->alpha?></td></tr>
               </table>
            </div>
