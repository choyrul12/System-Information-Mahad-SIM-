      ...
      <div class="row">
        <div class="col-12">
          ...
          <form id="form_1"  method="POST">
            ...
            <div class="card-body">
              <div id="tbDataStdKeterampilan_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
