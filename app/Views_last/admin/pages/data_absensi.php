    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
              ...
              <div id="tbDataAbsensi_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                <table width="150%" id="tbDataAbsensi" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataAbsensi_info">
                  <thead class="bg-gray-dark">
                    <tr role="row">
                      <th width="5%" rowspan="2"><div class='custom-control custom-checkbox'><input class='custom-control-input' type='checkbox' id='check-all' value='"+ value.id_nilai_Eskul+"'><label for='check-all' class='custom-control-label'>No</label></div></th>
          ...
          <button type="button" class="btn btn-md btn-danger ml-3 mt-3" onclick="deleteAbsensi()"><i class="fa fa-trash"></i> Delete Selected Data</button>
