      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?= base_url() ?>/assets/img/favicon.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
...
<script>
  $(function () {
    ...
    var form = [];
    $("form[id^='form_']").each(function(){form.push(this.id);});
  ...
  function tbDataPesdik(){
    $('#tbDataPesdik').DataTable({
      ...
      columns: [
        {data: 'id_pesdik', name: 'id_pesdik'},
        {data: 'nisn', name: 'nisn'},
        {data: 'nipd', name: 'nipd'},
        {data: 'nm_pesdik', name: 'tb_pesdik.nm_pesdik'},
        {data: 'romawi', name: 'romawi'},
        {data: 'rombel', name: 'tb_pesdik.rombel'},
        {data: 'rombel', name: 'rombel', visible: <?= (session()->get('level')<3) ? 'true' : 'false'; ?>},
      ],
  ...
  function tbDataRekamMedis(m){
    ...
    $('#tbDataRekamMedis').DataTable({
      ...
      columns: [
        {data: 'id_rekam_medis', name: 'id_rekam_medis'},
        {data: 'tgl_periksa', name: 'tgl_periksa'},
        {data: 'nm_pesdik', name: 'nm_pesdik'},
  ...
  function tbDataMapel(){
    $('#tbDataMapel').DataTable({
      ...
      columns: [
        ...
        {data: 'nm_mapel_ing', name: 'nm_mapel_ing'},
        {data: 'romawi', name: 'romawi'},
        {data: 'kelompok_mapel', name: 'kelompok_mapel'},
        {data: 'urutan_mapel', name: 'urutan_mapel'},
        {data: 'kd_mapel', name: 'kd_mapel'},
      ],
      "fnCreatedRow": function (row, data, index, aData) {
        var no = index + 1
  ...
  function tbDataGuru(){
    $('#tbDataGuru').DataTable({
      ...
      columns: [
        ...
        {data: 'accesskey', name: 'accesskey'},
        {data: 'username', name: 'username'},
        {data: 'status', name: 'status'},
        {data: 'id_guru', name: 'kls_mapel'}
      ],
      "fnCreatedRow": function (row, data, index, aData) {
        var no = index + 1
        $('td', row).eq(0).html("<div class='custom-control custom-checkbox'><input class='custom-control-input' type='checkbox' id='customCheckbox["+no+"]' value='option1'><label for='customCheckbox["+no+"]' class='custom-control-label'>"+no+"</label></div>");
  ...
  function tbDataThnAkademik(){
    $('#tbDataThnAkademik').DataTable({
      ...
      columns: [
        {data: 'kd_ta', name: 'kd_ta'},
        {data: 'kd_ta', name: 'kd_ta'},
        {data: 'thn_akademik', name: 'thn_akademik'},
  ...
  function tbDataAfektif(){
    $('#tbDataAfektif').DataTable({
      ...
      columns: [
        {data: 'id_afektif', name: 'id_afektif'},
  ...
  function tbDataEskul(){
    $('#tbDataEskul').DataTable({
      ...
      columns: [
        {data: 'id_eskul', name: 'id_eskul'},
        {data: 'nm_eskul', name: 'nm_eskul'},
        {data: 'id_eskul', name: 'id_eskul'}
      ],
      "fnCreatedRow": function (row, data, index, aData) {
        var no = index + 1
  ...
  function tbDataStdEskul(){
    $('#tbDataStdEskul').DataTable({
      ...
      columns: [
        {data: 'id_std_eskul', name: 'id_std_eskul'},
        {data: 'grade', name: 'grade'},
        {data: 'min', name: 'min'},
        {data: 'max', name: 'max'},
        {data: 'id_std_eskul', name: 'id_std_eskul'}
  ...
  function tbDataSekolah(){
    $('#tbDataSekolah').DataTable({
      ...
      columns: [
        ...
        {data: 'nm_sekolah', name: 'nm_sekolah'},
        {data: 'nm_kepsek', name: 'nm_kepsek'},
  ...
  function tbDataStdPengetahuan(){
    ...
    $.ajax({
      ...
      type : "POST",
      data:{kd_kelas:kls,kd_mapel:mapel},
      dataType : "JSON",
      success : function(data){
  ...
  function tbDataNilaiBulanan(){
    ...
    $.ajax({
      ...
      type : "POST",
      data:{ta:ta,id_kelas:id_kelas,id_rombel:id_rombel,id_mapel:id_mapel,bulan:bulan},
      dataType : "JSON",
      success : function(data){
  ...
  function tbDataNilaiEskul(){
    ...
    $.ajax({
      ...
      type : "POST",
      data:{ta:ta,id_kelas:id_kelas,id_rombel:id_rombel},
      dataType : "JSON",
      success : function(data){
  ...
  function tbDataNilaiMapel(){
    ...
    $.ajax({
      ...
      type : "POST",
      data:{ta:ta,id_kelas:id_kelas,id_rombel:id_rombel,id_mapel:id_mapel},
      dataType : "JSON",
      success : function(data){
  ...
  function tbDataRaporBulanan() {
    ...
    $.ajax({
      ...
      type : "POST",
      data:{ta:ta,id_kelas:id_kelas,id_rombel:id_rombel,bulan:bulan},
      dataType : "JSON",
      success : function(data){
