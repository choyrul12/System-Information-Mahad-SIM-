...
class RaporSemesterModel extends Model
{
    ...
    {
        $result = $this->query("SELECT tb_pesdik.id_pesdik, tb_pesdik.nisn, tb_pesdik.nm_pesdik FROM tb_pesdik INNER JOIN  tb_rapor_semester ON tb_pesdik.rombel = tb_rapor_semester.id_rombel WHERE id_rombel = $data[id_rombel] AND kd_ta = '$data[kd_ta]'")->getResultArray();
        return $result;
    }
