        ...
        <div class="col-12">
          ...
          <form id="form_1"  method="POST" enctype="multipart/form-data">
            <div class="card-header row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <select class="form-control" name="rombel" id="rombel" onchange="tbDataNilaiMapel()">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control" name="mapel" id="mapel" onchange="tbDataNilaiMapel()">
            ...
            <div class="card card-default" id="form-upload" style="display: none;">
              <div class="card-header">
                <h3 class="card-title">Form Upload Nilai Mapel</h3>
              ...
              <div class="card-body">
                <div class="row">
                    <div class="form-group">
                      <input type="hidden" value="/NilaiMapel/uploadDataNilaiMapel" name="action" id="action">
                      <input type="hidden" value="tbDataNilaiMapel()" name="table" id="table">
                    </div>
                  <div class="col-md-12">
                    <div class="callout callout-info">
                      Untuk upload nilai semester, pertama download format nilai excel melalui link berikut <button id="excelexportnilai" class="btn btn-info btn-sm" type="button">Download Format Nilai</button>, setelah itu isi file tersebut sesuai format, selanjutnya save dan upload file melalui form berikut.
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="hidden" value="/NilaiMapel/updateDataNilaiMapel" name="action" id="action">
                      <input type="hidden" value="tbDataNilaiMapel()" name="table" id="table">
            ...
            <div class="card-body">
              <form id="deleteNilai">
              <input type="hidden" id="url" value="/NilaiMapel/deleteDataNilaiMapel">
              <input type="hidden" id="tb" value="tbDataNilaiMapel()">
              <div id="tbDataNilaiMapel_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                <table width="100%" id="tbDataNilaiMapel" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataNilaiMapel_info">
                  <thead class="bg-gray-dark">
                    <tr role="row">
                      <th width="10" rowspan="2"><div class='custom-control custom-checkbox'><input class='custom-control-input' type='checkbox' id='check-all' value='"+ value.id_nilai_mapel+"'><label for='check-all' class='custom-control-label'>No</label></div></th>
                      <!-- <th width="20%">Nama Mapel</th> -->
                      <th width="15%" rowspan="2">NISN</th>
                      <th rowspan="2">Nama</th>
                      <th colspan="4" class="text-center" width="30%">Pengetahuan</th>
                      <th width="10%" rowspan="2">Keterampilan</th>
                      <th width="5%" rowspan="2">Action</th>
                    </tr>
                    <tr role="row">
                      <th class="text-center">PH & Tugas</th>
