        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header row">
              ...
              <div class="col-md-2">
                <button type="button" class="btn btn-primary btn-block btn-md pull-right" onclick="tbDataRaporSemester(),checkStatusRaporSemester()"><i class="fas fa-check mr-1"></i> Submit</button>
              </div>
              <div class="col-md-2">
                  <button type="button" class="btn btn-block" id="btnStatus" style="display: none;" onclick="formReleaseRaporSemester()"></button>
              </div>
            </div>           
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="hidden" value="/RaporSemester/terbitkanRaporSemester" name="action" id="action">
                      <input type="hidden" value="tbDataRaporSemester()" name="table" id="table">
            ...
            <div class="card-body">
              <div id="tbDataRaporSemester_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                <table width="100%" id="tbDataRaporSemester" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataRaporSemester_info">
