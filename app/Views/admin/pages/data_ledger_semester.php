...
<section class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <form action="<?= base_url('/administrator/data-ledger-semester') ?>" method="GET" enctype="multipart/form-data">
                  ...
                  <table style="width: 150%;" id="tbDataLadger" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataLadger_info">
                    <thead class="bg-gray-dark">
                      <tr role="row">
                        ...
                        <th rowspan="3" class="text-center" width="5px" style="background-color: #00917C;">Rank</th>
                      </tr>
                      <tr role="row">
                    ...
                    <tbody>
                      ...
                      foreach ($list_pesdik->getResultArray() as $lp) : ?>
                        <tr>
                          ...
                          <?php endforeach; ?>
                          <td style="text-align:right; background-color: #A4EBF3;"><strong><?= $amount = $tp + $tk;
                                                                                            $ap = $amount / ($list_mapel->getNumRows() * 2);
