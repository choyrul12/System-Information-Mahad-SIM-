        ...
        <div class="col-12">
          ...
          <form id="form_1"  method="POST" enctype="multipart/form-data">
            <div class="card-header row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control" name="rombel" id="rombel" onchange="tbDataAbsensi()">
            ...
            <div class="card card-default" id="form-upload" style="display: none;">
              ...
              <div class="card-body">
                <div class="row">
                    <div class="form-group">
                      <input type="hidden" value="/Absensi/uploadDataAbsensi" name="action" id="action">
                      <input type="hidden" value="tbDataAbsensi()" name="table" id="table">
                    </div>
                  <div class="col-md-12">
                    <div class="callout callout-info">
                      Untuk upload data absensi semester, pertama download format absensi excel melalui link berikut <button id="excelexportabsensi" class="btn btn-info btn-sm" type="button">Download Format Absensi</button>, setelah itu isi file tersebut sesuai format, selanjutnya save dan upload file melalui form berikut.
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="hidden" value="/Absensi/updateDataAbsensi" name="action" id="action">
                      <input type="hidden" value="tbDataAbsensi()" name="table" id="table">
                  ...
                  <div class="col-md-2">
                      <label>Sakit</label>
                      <input class="form-control" name="sakit" id="sakit" placeholder="Sakit">
                      <span id="sakit-feedback" class="error invalid-feedback"></span>
                  </div>
                  <div class="col-md-2">
                      <label>Izin</label>
                      <input class="form-control" name="izin" id="izin" placeholder="Izin">
                      <span id="izin-feedback" class="error invalid-feedback"></span>
                  </div>
                  <div class="col-md-2">
                      <label>Alpha</label>
                      <input class="form-control" name="alpha" id="alpha" placeholder="Alpha">
                      <span id="alpha-feedback" class="error invalid-feedback"></span>
                  </div>
                </div>
              </div>
              <div class="card-footer">
            ...
            <div class="card-body">
              <form id="deleteAbsensi">
              <input type="hidden" id="url" value="/Absensi/deleteDataAbsensi">
              <input type="hidden" id="tb" value="tbDataAbsensi()">
              <div id="tbDataAbsensi_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                <table width="150%" id="tbDataAbsensi" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="tbDataAbsensi_info">
                  <thead class="bg-gray-dark">
                    <tr role="row">
                      <th width="5%" rowspan="2"><div class='custom-control custom-checkbox'><input class='custom-control-input' type='checkbox' id='check-all' value='"+ value.id_absensi+"'><label for='check-all' class='custom-control-label'>No</label></div></th>
                      <th width="9%" rowspan="2">NISN</th>
                      <th rowspan="2" width="50%">Nama</th>
                      <th colspan="3" class="text-center" width="20%">Keterangan</th>
