            ...
            <li>
              ...
              <div class="timeline-body">
                  <div class="timeline-header">
                    <span class="username"><?= ucfirst($rm['diagnosis']) ?></span>
                  </div>
                  ...
                  <button class="btn btn-sm btn-primary" style="float: right;" data-bs-toggle="modal" data-bs-target="#detail-healt-report<?=$n1++;?>">Detail</button>
              </div>
            </li>
  ...
  <div class="modal fade" id="detail-healt-report<?= $n1++; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <p class="lead"><?= $rm['pemeriksaan_fisik'] ?></p>
        <hr>
        <p>Penanganan :</p>
        ...
        <hr>
        <p>Status :</p>
        <p class="lead"><?= $rm['status'] ?></p>
        <hr>
        <p>Nama Petugas :</p>
        <p class="lead"><?= $rm['petugas'] ?></p>
        </div>
