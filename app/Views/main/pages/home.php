          ...
          <div class="card card-plain">
            ...
            <div class="card-body">
              <form role="form text-left" id="searchMonthlyReport">
                ...
                <div class="input-group mb-3">
                  <input type="month" class="form-control" name="month" required placeholder="Select Month">
                </div>
            ...
            <div class="card-body">
              <form role="form text-left" id="searchSemesterReport">
                <div class="input-group mb-3">
                  <select class="form-control" name="ta" required>
                    <option value="">Select Academic Year</option>
                    <?php foreach($ta->getResultArray() AS $ta): ?>
                    <option value="<?=$ta['kd_ta']?>"><?=$t['thn_akademik']." ".$ta['semester'];?></option>
                    <?php endforeach;?>
                  </select>
                </div>
                <div class="input-group mb-3">
