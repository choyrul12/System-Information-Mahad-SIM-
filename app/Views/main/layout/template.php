          ...
          success: function (e) {
            switch(e.notif){
              case "Success": 
                ...
                window.location.href="<?=base_url()?>/monthly-report?id="+e.id+"&ta="+e.kd_ta+"&kls="+e.kls+"&rombel="+e.id_rombel+"&month="+e.bulan+""
                break;
              case "Failed": 
                Toast.fire({
                icon: 'error',
          ...
          success: function (e) {
            switch(e.notif){
              case "Success": 
                ...
                window.location.href="<?=base_url()?>/semester-report?id="+e.id+"&ta="+e.kd_ta+"&kls="+e.kls+"&rombel="+e.id_rombel+""
                break;
              case "Failed": 
                Toast.fire({
                icon: 'error',
