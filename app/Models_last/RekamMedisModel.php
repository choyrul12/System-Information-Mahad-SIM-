...
class RekamMedisModel extends Model{
    ...
    protected $allowedFields = ['id_pesdik', 'tgl_periksa', 'anamnesa','penanganan', 'diagnosis', 'obat', 'note', 'petugas'];
    protected $userModel;
    ...
    public function getDataRekamMedisByMonth($month)
    {
        ...
        ->select('id_rekam_medis, tb_rekam_medis.id_pesdik as id_pesdik, tgl_periksa, anamnesa, diagnosis, penanganan, obat, note, petugas, tb_pesdik.nm_pesdik as nm_pesdik')
        ->join('tb_pesdik ', 'tb_pesdik.id_pesdik = tb_rekam_medis.id_pesdik', 'INNER JOIN')
        ->join('tb_user ', 'tb_pesdik.nisn = tb_user.accesskey', 'INNER JOIN')
