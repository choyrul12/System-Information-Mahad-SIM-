...
class RaporBulananModel extends Model
{
    ...
    protected $allowedFields = ['id_rapor_bulanan', 'bulan_rapor', 'id_rombel', 'kd_ta', 'wali_kelas', 'kota_terbit' , 'tgl_terbit'];
    protected $userModel;
    ...
    {
        $result = $this->select('tb_rapor_bulanan.*, tb_guru.username, tb_sekolah.nm_kepsek')
